...
INSERT INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES
('NV001', 'Nguyen Van A', 'Nam', TO_DATE('1985-01-01', 'YYYY-MM-DD'), 'Hanoi', '0901234567', 10.0, 'nguyenvana@example.com', 'pass123');

INSERT INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES
('NV002', 'Tran Thi B', 'Nu', TO_DATE('1990-02-01', 'YYYY-MM-DD'), 'Hanoi', '0901234568', 12.0, 'tranthib@example.com', 'pass124');

INSERT INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES
('NV003', 'Le Van C', 'Nam', TO_DATE('1988-03-01', 'YYYY-MM-DD'), 'Hanoi', '0901234569', 11.0, 'levanc@example.com', 'pass125');



INSERT ALL
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV004', 'Phan Thi D', 'Nu', TO_DATE('1992-04-01', 'YYYY-MM-DD'), 'Hanoi', '0901234570', 13.0, 'phanthid@example.com', 'pass126')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV005', 'Hoang Van E', 'Nam', TO_DATE('1986-05-01', 'YYYY-MM-DD'), 'Hanoi', '0901234571', 10.0, 'hoangvane@example.com', 'pass127')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV006', 'Dang Thi F', 'Nu', TO_DATE('1995-06-01', 'YYYY-MM-DD'), 'Hanoi', '0901234572', 11.0, 'dangthif@example.com', 'pass128')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV007', 'Nguyen Van G', 'Nam', TO_DATE('1987-07-01', 'YYYY-MM-DD'), 'Hanoi', '0901234573', 12.0, 'nguyenvang@example.com', 'pass129')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV008', 'Tran Thi H', 'Nu', TO_DATE('1991-08-01', 'YYYY-MM-DD'), 'Hanoi', '0901234574', 13.0, 'tranthih@example.com', 'pass130')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV009', 'Le Van I', 'Nam', TO_DATE('1984-09-01', 'YYYY-MM-DD'), 'Hanoi', '0901234575', 14.0, 'levani@example.com', 'pass131')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV010', 'Pham Thi J', 'Nu', TO_DATE('1993-10-01', 'YYYY-MM-DD'), 'Hanoi', '0901234576', 14.0, 'phamthij@example.com', 'pass132')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV011', 'Bui Van K', 'Nam', TO_DATE('1989-11-01', 'YYYY-MM-DD'), 'Hanoi', '0901234577', 15.0, 'buivank@example.com', 'pass133')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV012', 'Do Thi L', 'Nu', TO_DATE('1983-12-01', 'YYYY-MM-DD'), 'Hanoi', '0901234578', 15.0, 'dothil@example.com', 'pass134')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV013', 'Nguyen Van M', 'Nam', TO_DATE('1982-01-01', 'YYYY-MM-DD'), 'Hanoi', '0901234579', 16.0, 'nguyenvanm@example.com', 'pass135')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV014', 'Tran Thi N', 'Nu', TO_DATE('1996-02-01', 'YYYY-MM-DD'), 'Hanoi', '0901234580', 16.0, 'tranthin@example.com', 'pass136')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV015', 'Le Van O', 'Nam', TO_DATE('1981-03-01', 'YYYY-MM-DD'), 'Hanoi', '0901234581', 17.0, 'levano@example.com', 'pass137')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV016', 'Pham Thi P', 'Nu', TO_DATE('1994-04-01', 'YYYY-MM-DD'), 'Hanoi', '0901234582', 17.0, 'phamthip@example.com', 'pass138')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV017', 'Bui Van Q', 'Nam', TO_DATE('1980-05-01', 'YYYY-MM-DD'), 'Hanoi', '0901234583', 18.0, 'buivanq@example.com', 'pass139')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV018', 'Do Thi R', 'Nu', TO_DATE('1997-06-01', 'YYYY-MM-DD'), 'Hanoi', '0901234584', 18.0, 'dothir@example.com', 'pass140')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV019', 'Nguyen Van S', 'Nam', TO_DATE('1979-07-01', 'YYYY-MM-DD'), 'Hanoi', '0901234585', 19.0, 'nguyenvans@example.com', 'pass141')
    INTO NHANVIEN (MANV, TENNV, GIOITINH, NGAYSINH, DIACHI, SDT, LUONG, Email, PASSWORD) VALUES ('NV020', 'Tran Thi T', 'Nu', TO_DATE('1998-08-01', 'YYYY-MM-DD'), 'Hanoi', '0901234586', 19.0, 'tranthit@example.com', 'pass142')
SELECT * FROM dual;
...
BEGIN
  IF :NEW.GIABAN <= :NEW.GIANHAP THEN
    RAISE_APPLICATION_ERROR(-20001, 'Giá bán ph?i l?n h?n giá nh?p.');
  END IF;
END;
/
...
BEGIN
    -- Tìm mã hóa ??n m?i nh?t
    SELECT 'HD' || LPAD(NVL(MAX(SUBSTR(MAHD, 3)), 0) + 1, 3, '0')
    INTO v_new_ma_hd
    FROM HOADON;

    -- Gán mã hóa ??n m?i vào tr??ng MAHD c?a hàng m?i
...
BEGIN
    -- Tìm mã khách hàng m?i nh?t
    SELECT 'KH' || LPAD(NVL(MAX(SUBSTR(MAKH, 3)), 0) + 1, 3, '0')
    INTO v_new_ma_kh
    FROM KHACHHANG;

    -- Gán mã khách hàng m?i vào tr??ng MAKH c?a hàng m?i
...
DECLARE
    ...
    v_max_num NUMBER;
BEGIN
    -- L?y giá tr? s? l?n nh?t t? c?t MASP có ??nh d?ng SPxxx
    SELECT MAX(TO_NUMBER(SUBSTR(MASP, 3)))
    INTO v_max_num
    FROM SANPHAM
    WHERE REGEXP_LIKE(MASP, '^SP[0-9]{3}$');

    -- N?u không có giá tr? nào th?a mãn, b?t ??u t? 1
    IF v_max_num IS NULL THEN
        v_max_num := 1;
    ELSE
        v_max_num := v_max_num + 1;
    ...
    -- T?o mã s?n ph?m m?i v?i ??nh d?ng SPxxx
...
COMPOUND TRIGGER
    ...
    g_new_promotions PromotionTableType := PromotionTableType();  -- Khai báo bi?n

    BEFORE EACH ROW IS
    BEGIN
        IF :NEW.isDeleted = 0 THEN  -- Ch? ki?m tra khi khuy?n mãi không b? xóa
            -- Ki?m tra trùng l?p khuy?n mãi
            DECLARE
                v_count INTEGER;
            BEGIN
                ...
                IF v_count > 0 THEN
                    RAISE_APPLICATION_ERROR(-20001, 'M?t s?n ph?m ch? có th? có m?t khuy?n mãi ho?t ??ng t?i m?t th?i ?i?m.');
                END IF;
            END;

            -- Ki?m tra ngày k?t thúc khuy?n mãi
            IF :NEW.NGAYKT < SYSDATE THEN
                RAISE_APPLICATION_ERROR(-20002, 'Ngày k?t thúc khuy?n mãi không th? n?m trong quá kh?.');
            END IF;
        END IF;
    END BEFORE EACH ROW;
...
DECLARE
    v_sl_nhap NUMBER;
BEGIN
    -- L?y s? l??ng nh?p t? hàng m?i
    v_sl_nhap := :NEW.SLNHAP;

    -- C?p nh?t SLSP trong SANPHAM (n?u MASP t?n t?i) b?ng cách c?ng d?n v?i s? l??ng nh?p
    UPDATE SANPHAM
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            NULL; -- B? qua n?u MASP không t?n t?i trong SANPHAM
END;
/
...
CREATE OR REPLACE PROCEDURE GET_DISCOUNT_AND_VALUE (
    ...
    v_giaban FLOAT := 0;
    v_chietkhau FLOAT := 0; -- ??t m?c ??nh chi?t kh?u là 0
    v_soluongton INT := 0;
BEGIN
    -- L?y giá bán và s? l??ng t?n kho c?a s?n ph?m
    BEGIN
    ...
    IF p_soluong > v_soluongton THEN
        RAISE_APPLICATION_ERROR(-20001, 'S? l??ng ??t hàng l?n h?n s? l??ng t?n kho');
    END IF;
    -- Ki?m tra n?u khách hàng không ph?i là khách hàng l? (MAKH = 'KH000')
    IF p_makh != 'KH000' THEN
        -- L?y chi?t kh?u c?a mã khuy?n m?i n?u có và n?u khuy?n m?i ?ang có hi?u l?c
        BEGIN
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                v_chietkhau := 0; -- Không có khuy?n mãi h?p l?
        END;
    ELSE
        -- N?u là khách hàng l?, không áp d?ng khuy?n mãi
        v_chietkhau := 0;
    END IF;

    -- Tính tr? giá sau khi áp d?ng chi?t kh?u
    p_trigia := p_soluong * v_giaban * (1 - v_chietkhau);

    -- Gán chi?t kh?u vào tham s? OUT
    p_chietkhau := v_chietkhau;
EXCEPTION
    WHEN OTHERS THEN
        RAISE; -- X? lý l?i n?u c?n thi?t
END;
/
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('T?ng tr? giá c?a hóa ??n ' || p_MAHD || ' ?ã ???c c?p nh?t thành công.');
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    FOR r_hd IN cur_hd LOOP
        -- Tính t?ng tr? giá t? b?ng CTHD cho hóa ??n hi?n t?i
        SELECT SUM(TRIGIA)
        INTO v_tongdt
        FROM CTHD
